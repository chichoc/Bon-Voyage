...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="../img/square_paris3.jpg" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="../img/square_paris.png" style="width:100%">

  </div>

  <div class="mySlides fade">
    <div class="numbertext">3 / 3</div>
    <img src="../img/square_paris2.jpg" style="width:100%">
...
<script type="text/javascript">
	...
	var Y_point			= 48.858547;		// Y 좌표
	var X_point			= 2.294471;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "Paris";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기

// 말풍선 내용
	var contentString	= '<div>' +
	'<h2>Paris</h2>'+
	'<p>에펠 탑 5 Avenue Anatole France, 75007 Paris, 프랑스</p>' +
