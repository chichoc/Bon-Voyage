...
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="../img/square_hongkong2.jpg" style="width:100%">
  </div>

  <div class="mySlides fade">
    <div class="numbertext">2 / 3</div>
    <img src="../img/square_hongkong.jpg" style="width:100%">
...
<div id ="guide_view">
    <img src="../img/hongkong1.JPG">
    <img src="../img/hongkong2.JPG">
    <img src="../img/hongkong3.JPG">
...
<script type="text/javascript">
	...
	var Y_point			= 22.28396;		// Y 좌표
	var X_point			= 114.155103;		// X 좌표
	var zoomLevel		= 18;				// 지도의 확대 레벨 : 숫자가 클수록 확대정도가 큼
	var markerTitle		= "HongKong";		// 현재 위치 마커에 마우스를 오버을때 나타나는 정보
	var markerMaxWidth	= 300;				// 마커를 클릭했을때 나타나는 말풍선의 최대 크기

// 말풍선 내용
	var contentString	= '<div>' +
	'<h2>HongKong</h2>'+
	'<p>Game Centre, 1 Jubilee St, Central</p>' +
