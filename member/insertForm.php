<?php
 ...
 <script>
 function check_id() //아이디 중복체크. doument는 자바.
 {
 ...
 <div id="join2">
  <ul>
   ...
   <li><div id="name"><input type="text" name="name" required ></li>
  ...
  <li><div id="address"><input type="text" name="address" required ></li>
