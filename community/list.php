<?php
 ...
 <?php
  ...
  <?php
   ...
   $sql="select * from phptest2.community where $find like '%$search%' order by num desc";
  } else {
   $sql="select * from phptest2.community order by num desc";
  }
  try{  
    $stmh = $pdo->query($sql); 
    $count=$stmh->rowCount(); 
  ...
  <div id="wrap">
    ...
    <div id="content">
      <div id="col1">
        <div id="left_menu">
         <?php include "../lib/left_menu_c.php"; ?>
        </div> 
      </div> <!-- end of col1 -->

    <div id="col2">
      <div id="title"><img src="../img/title_community.png"></div>
   ...
   function latest_article($table, $loop, $char_limit) 
   {
    ...
    try{
      ...
      while($row = $stmh->fetch(PDO::FETCH_ASSOC)) 
      {
       ...
       echo(" 
        <div class='col1'>
           <a href='../$table/view.php?num=$num'><b>[BEST$item_num]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$subject&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           </div><div class='col2'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$item_nick&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$item_date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$hit</div>
         <div class='clear'></div><div class='clear'></div></b>
       ");
       }
 ...
 ?>
    ...
    <div class="latest_box">
     <?php latest_article("community", 5,5 ); ?>
    </div><br>
