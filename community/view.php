 ...
 try{
     $sql = "select * from phptest2.community where num=?";
	...
	$item_content = str_replace(" ", "&nbsp;", $item_content);
     ...
     try{
       ...
       $sql = "update phptest2.community set hit=? where num=?";   // 조회수 증가
       $stmh = $pdo->prepare($sql);  
 ...
 <div id="wrap">
  ...
  <div id="content">
     <div id="col1">
	<div id="left_menu"><?php include "../lib/left_menu_c.php"; ?></div>
     </div>
      <div id="col2">
 ...
 <?php
 try{
   $sql = "select * from phptest2.community_ripple where parent='$item_num'";
